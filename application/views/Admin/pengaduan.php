...
<body>
		...
		<div class="row">
			<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
				<div class="sidebar-sticky pt-3">
					<ul class="nav flex-column">
						<li class="nav-item">
							<a class="nav-link active" href="<?php echo site_url('sistem/datauser');?>">
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
				<div
					...
					<div class="btn-toolbar mb-2 mb-md-0">
						<div class="btn-group mr-2">
							<a href="<?php echo site_url('sistem/export2')?>"><button type="button"
									class="btn btn-sm btn-outline-secondary">Excel</button></a>
							<a href="<?php echo site_url('sistem/cetak2')?>"> <button type="button"
				...
				<div class="table-responsive">
					<table class="table table-striped table-sm" id="dataLelang">
						<thead>
							<tr>
								<th>Id</th>
								<th>Judul</th>
	...
	<?php $this->load->view("partials/edit.php") ?>
	
</body>

<?php $this->load->view("partials/footer") ?>

<?php $this->load->view("partials/ajaxP") ?>
